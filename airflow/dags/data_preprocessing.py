...
def preprocess_data():
    ...
    df = pd.read_csv(r"C:\Users\PC\Downloads\mlops-project\mlops-project\data\weather_data.csv")
    
    # Save processed data path
    processed_data_path = r"C:\Users\PC\Downloads\mlops-project\mlops-project\data\processed_data.csv"
    ...
    try:
        ...
        with mlflow.start_run(run_name="Data Preprocessing"):
            ...
            joblib.dump(scaler, r'C:\Users\PC\Downloads\mlops-project\mlops-project\models\scaler.pkl')
